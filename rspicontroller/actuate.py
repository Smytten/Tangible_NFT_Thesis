if __name__ == "__main__":
    ...
    from rspicontroller.servo_controller import rspiServo
    from rspicontroller.servo_controller import multipleServoController
...
def actuateSinge(motor,degree):
    servos[motor].rotate(degree)
